...
**Media Inquiries:**
- **Email**: press@grainpbc.org
- **Phone**: [To be provided]
- **Website**: https://grainpbc.org
- **Social**: @grainpbc on all platforms

**Technical Inquiries:**
- **Email**: tech@grainpbc.org
- **GitHub**: https://github.com/grainpbc
- **Documentation**: https://docs.grainpbc.org

#### **Links and Resources**

- **Crowd Supply**: https://www.crowdsupply.com/grainpbc/grainphone
- **Kickstarter**: https://www.kickstarter.com/projects/grainpbc/grainphone
- **Website**: https://grainpbc.org
- **GitHub**: https://github.com/grainpbc
...
- **Documentation**: https://grainpbc.github.io/docs/
- **Community**: https://grainpbc.github.io/community/

### **Codeberg Pages**
- **Main Site**: https://grainpbc.codeberg.page/
- **Press Kit**: https://grainpbc.codeberg.page/press/
- **Documentation**: https://grainpbc.codeberg.page/docs/
- **Community**: https://grainpbc.codeberg.page/community/
